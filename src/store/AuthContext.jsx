  ...
  useEffect(() => {
    ...
    const { data: { subscription: authSub } } = supabase.auth.onAuthStateChange(
      async (event, s) => {
        ...
        // Skip token refreshes — the Supabase client already has the
        // new token internally. Updating React state here would re-render
        // the entire app tree, causing loading flashes on every tab switch.
