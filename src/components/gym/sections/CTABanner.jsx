    ...
    >
      ...
      <div className="relative max-w-5xl mx-auto px-6 py-28 text-center">
        ...
        <motion.div variants={fadeUp}>
          <Link
            to={`/${slug}/pricing`}
            className="group inline-flex items-center gap-3 px-10 py-5 bg-white font-bold text-sm font-sans transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl"
