...
export default function HeroA({ data }) {
  ...
  return (
    ...
    >
          ...
          {/* Title */}
            ...
            {titleLines.map((line, i) => (
              <motion.h1
                ...
                style={{ fontSize: 'var(--gym-h1-size, clamp(3rem, 7vw, 7rem))', overflowWrap: 'break-word', wordBreak: 'break-word' }}
              >
                {line}
              </motion.h1>
            ))}
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-3 shrink-0">
              <Link
                ...
                className="group inline-flex items-center justify-center gap-2 px-8 py-4 text-sm font-bold text-white transition-all duration-300 hover:-translate-y-0.5 hover:shadow-2xl font-sans"
                style={{
                  background: 'var(--gym-gradient)',
                  boxShadow: '0 8px 30px var(--gym-glow-strong)',
              ...
              <Link
                ...
                className="inline-flex items-center justify-center px-8 py-4 text-sm font-bold text-white border border-white/20 hover:bg-white/10 transition-all duration-300 hover:-translate-y-0.5 font-sans"
                style={{
                  backdropFilter: 'blur(10px)',
                  borderRadius: 'var(--gym-card-radius)'
                }}
      ...
      >
        ...
        />
        <span className="text-white/30 text-[10px] tracking-[0.2em] font-sans uppercase" style={{ writingMode: 'vertical-rl' }}>
          Scroll
        </span>
      </motion.div>
  ...
  className="
    ...
    max-w-[50%] sm:max-w-sm md:max-w-md
  "
>
