...
export default function MemberLayout() {
  ...
  // important because /member-app is reachable on both main host and tenant
  // hosts, and navigating away (e.g., signOut to gym portal) shouldn't leave
  // the gym favicon stuck on the next page.
  useDocumentHead({
    title:      gym?.name ? `${gym.name} — Member` : undefined,
